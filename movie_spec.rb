...
describe Movie do
  ...
  it "has a string representation" do
    @movie.to_s.should == "Goonies has a rank of 10 #{@movie.status}"
  end

  it "increase rank by 1 when given a thumbs up" do
    @movie.thumbs_up
